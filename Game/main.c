...
int main(void) {
    ...
    p1 = pokemon_player1(entrada, p1, opcao1);
    p2 = pokemon_player2(entrada, p2, opcao2);
    ...
    while (!fim_jogo) {   
        ...
        while (!fim_luta)
        {
            ...
            if (vez){ // Na vez do jogador 1
                p2 = ataque(p1, p2); // p2 sofre o ataque
                vez = false; // troca a vez
            } else { // Na vez do jogador 2
                p1 = ataque(p2, p1); // p1 sofre o a ataque
            ...
            if (p1.vida <= 0) { // Se p1 é derrotado
                ...
                if (qtd_player1 - opcao1 < 0) { // Se acabam as opções de pokemon para o jogador 1
                    ...
                    p1 = pokemon_player1(entrada, p1, opcao1); // trocar pokemon do jogador 1
                }
                ...
                if (qtd_player2 - opcao2 < 0) { // Se acabam as opções de pokemon para o jogador 2
                    ...
                    p2 = pokemon_player2(entrada, p2, opcao2); // trocar pokemon do jogador 2
                }
